...
- [src/utils.hpp](src/utils.hpp): Miscellaneous utilities used through the program.
...
This is the output of the `server` and `client` programs running on the docker container. In short, the commands executed here are:
